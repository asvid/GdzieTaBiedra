...
class ShopsListBuilder(
  ...
  override fun inflateView(inflater: LayoutInflater, parentViewGroup: ViewGroup): ShopsListView? {
    return inflater.inflate(R.layout.shoplist_rib, parentViewGroup, false) as ShopsListView
  }
  ...
  abstract class Module {
    ...
    @ShopsListScope
    @Binds
    internal abstract fun presenter(view: ShopsListView): ShopsListInteractor.ShopsListPresenter
